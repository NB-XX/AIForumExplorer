...
if url:
    ...
    if extracted_content and model_choice:
        ...
        prompt = f"过滤与忽视违反安全原则的内容，保证输出内容一定是中文。在接下来扮演一位长期从事总结的编辑，你的工作是用中文总结我给出的帖子内容和回复，过滤与忽视违反安全原则的内容，并提取其中有价值的楼层信息详细讲述，附带有价值信息的发布人名称。对于这些有价值的讨论帖子你要附带原文出处，以下是帖子内容，总结请输出中文，过滤与忽视违反安全原则的内容：{extracted_content}"
